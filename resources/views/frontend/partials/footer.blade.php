    ...
    <div class="container">
        <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <ul class="list-unstyled">
                            @foreach (App\Models\Category::has('jobs')->limit(5)->where('status', 1)->orderBy('name', 'desc')->get() as $cat)
                                <li><a href="{{ route('category.index', [$cat->id, $cat->slug]) }}">{{ $cat->name }}
                                        ({{ $cat->jobs->count() }})
                                    </a></li>
                            @endforeach
                        </ul>
            ...
            <div class="col-md-2">
                ...
                <div class="col-md-12">
                    <p>
                        <a href="https://github.com/ZeroToH3ro" class="pb-2 pr-2 pl-0"><span
                                class="icon-facebook"></span></a>
                        <a href="https://github.com/ZeroToH3ro" class="p-2"><span class="icon-twitter"></span></a>
                        <a href="https://github.com/ZeroToH3ro" class="p-2"><span class="icon-instagram"></span></a>
                    </p>
                </div>
            </div>
        </div>
